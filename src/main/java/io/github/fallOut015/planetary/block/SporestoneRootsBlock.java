...
public class SporestoneRootsBlock extends Block {
    ...
    public SporestoneRootsBlock(Properties properties) {
        super(properties);
    ...
    private boolean canAttachTo(IBlockReader blockReader, BlockPos blockPos, Direction direction) {
        ...
        return !blockstate.isSignalSource() && blockstate.isFaceSturdy(blockReader, blockPos, direction);
    }
