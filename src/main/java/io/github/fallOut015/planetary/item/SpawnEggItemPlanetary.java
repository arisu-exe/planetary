...
public class SpawnEggItemPlanetary extends Item {
    private static final Map<LazyValue<EntityType<?>>, SpawnEggItemPlanetary> EGGS = Maps.newIdentityHashMap();
    private final int primaryColor;
    private final int secondaryColor;
    private final LazyValue<EntityType<?>> typeIn;

    public SpawnEggItemPlanetary(Supplier<EntityType<?>> typeIn, int primaryColorIn, int secondaryColorIn, Item.Properties builder) {
        super(builder);
    ...
    @Nullable
    @OnlyIn(Dist.CLIENT)
    public static SpawnEggItemPlanetary getEgg(@Nullable EntityType<?> type) {
    ...
    public static Iterable<SpawnEggItemPlanetary> getEggs() {
